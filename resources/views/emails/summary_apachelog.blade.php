    ...
    <tr>
		...
		@foreach ($logs['data'] as $data)
			<tr>
				...
				<td width="100" valign="top">{{ $data['ip'] }}</td>
				<td width="100" valign="top">{{ $data['method'] }}</td>
				<td width="500" valign="top">{{ $data['code'] }}</td>
			</tr>
		@endforeach
		</table>
